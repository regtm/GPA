...
std::atomic<unsigned> shared_repaint_id(0);
unsigned last_repaint_id(0);
...
int main()
{
	...
	while (true)
	{
		...
		if (shared_repaint_id.compare_exchange_strong(last_repaint_id, last_repaint_id) == false)
		{
